...
class Gate
{
    ...
    public function __construct(){
        ...
        //初始化各个GatewayWorker
        //初始化register register 服务必须是text协议s
        ...
        $worker->count = 4;
        // 服务注册地址
        $worker->registerAddress = '127.0.0.1:5659';
        //设置处理业务的类,此处制定Events的命名空间
        $worker->eventHandler = 'app\socket\controller\Events';
        // 初始化 gateway 进程
        $gateway = new Gateway("websocket://0.0.0.0:6869");
        // 设置名称，方便status时查看
        ...
        // 服务注册地址
        $gateway->registerAddress = '127.0.0.1:5659';
